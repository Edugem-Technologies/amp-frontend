...
const ProgressSelect = ({ options }: ProgressSelectProps) => {
    const [selectedProgress, setSelectedProgress] = useState<Option | null>(null)
    ...
    return (
        <div className="w-100">
            <BaseStaticSelect
                ...
                onSelected={(selected) => setSelectedProgress(selected as Option)}
