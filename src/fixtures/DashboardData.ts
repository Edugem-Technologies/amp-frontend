    ...
    progressCharts: [
        {
            ...
            iconBgClass: "bg-light-success text-success",
            data: [
                { month: "Jan", value: 20 },
                { month: "Feb", value: 25 },
                { month: "Mar", value: 22 },
...

        {
            ...
            iconBgClass: "bg-light-danger text-danger",
        ...
        },
        {
            ...
            iconBgClass: "bg-light-primary text-primary",
        ...
        tasks: [
            {
                id: "1",
                time: "08:42",
                title: `<p class="mb-0 text-muted">Outlines keep you honest. And keep structure</p>`,
                color: "#E6FFF3",
            },
            {
                id: "2",
                time: "10:00",
                title: `<p class="mb-0 text-strong">AEOL meeting</p>`,
                color: "#E6FFF3",
            },
            {
                id: "3",
                time: "14:37",
                title: `<p class="mb-0 text-strong">Make deposit <span class="text-minty">USD 700</span>. to ESL</p>`,
                color: "#E6FFF3",
            },
            {
                id: "4",
                time: "16:50",
                title: `<p class="mb-0 text-muted">Indulging in poorly driving and keep structure keep great</p>`,
                color: "#E6FFF3",
            },
            {
                id: "5",
                time: "21:03",
                title: `<p class="mb-0 text-highlighted">New order placed <span>#XF-2356</span>.</p>`,
                color: "#E6FFF3",
            },
            {
                id: "6",
            ...
            },
            {
                id: "8",
                time: "10:30",
                title: `<p class="mb-0 text-muted">Finance KPI Mobile app launch preparion meeting</p>`,
                color: "#E6FFF3",
            },
        ],
    },
            ...
            stats: [
                {
                    ...
                    amount: 2034,
                    icon: "paint",
                    btnClass: "bg-light-info",
                    iconBgClass: "svg-icon-info",
                },
                {
                    title: "Commission",
                    amount: 706,
                    icon: "stack",
                    btnClass: "bg-light-danger",
                    iconBgClass: "svg-icon-danger ",
                },
                {
                    title: "Average Bid",
                    amount: 29004,
                    icon: "cake",
                    btnClass: "bg-light-success",
                    iconBgClass: "svg-icon-success",
                },
                {
                    title: "All Time Sales",
                    amount: 148000,
                    icon: "barcode",
                    btnClass: "bg-light-primary",
                    iconBgClass: "svg-icon svg-icon-1 svg-icon-primary",
                },
            ],
            chart: {
                color: "#111111",
    ...
    contributorData: [
        {
            ...
            lineWidth: 4,
            data: [
                { label: "Jan", inflation: 3.8 },
                { label: "Feb", inflation: 3.8 },
                { label: "Mar", inflation: 4.8 },
                { label: "Apr", inflation: 6.2 },
                { label: "May", inflation: 7.0 },
                { label: "Jun", inflation: 5.0 },
                { label: "Jul", inflation: 3.1 },
                { label: "Aug", inflation: 10.1 },
                { label: "Sep", inflation: 2.8 },
                { label: "Oct", inflation: 1.9 },
                { label: "Nov", inflation: 9.1 },
                { label: "Dec", inflation: 0.1 },
            ],
        },
        {
            title: "Contributors",
