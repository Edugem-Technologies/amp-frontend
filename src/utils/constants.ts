export const config = {
    ...
    MESSAGES: {
        ...
        CONTRACT_COPY_SUCCESS:
            "Contract copied successfully. Please update contract content accordingly",
        ...
        VALIDATION_MESSAGES: {
            ONLY_LETTERS_DIGITS_SCORES:
                "Only a combination of letters, digits, underscores, and spaces is allowed",
